      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="mb-6 bg-techbiz-purple/10 text-techbiz-purple border-techbiz-purple/20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-techbiz-grey/20 bg-techbiz-black/50 hover:bg-techbiz-black/70 transition-colors">
              <CardHeader>
                ...
                <CardTitle className="text-techbiz-white">Time-Consuming Processes</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-techbiz-grey/20 bg-techbiz-black/50 hover:bg-techbiz-black/70 transition-colors">
              <CardHeader>
                ...
                <CardTitle className="text-techbiz-white">Lack of Tracking</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-techbiz-grey">
            ...
            <Card className="border-techbiz-grey/20 bg-techbiz-black/50 hover:bg-techbiz-black/70 transition-colors">
              <CardHeader>
                ...
                <CardTitle className="text-techbiz-white">Dependency on Middlemen</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-techbiz-grey">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="text-center border-techbiz-grey/20 bg-techbiz-black/50 hover:bg-techbiz-black/70 transition-colors">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg text-techbiz-white">{feature.title}</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base text-techbiz-grey">
                    {feature.description}
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                <Button variant="outline" size="sm" className="border-techbiz-purple/30 text-techbiz-purple hover:bg-techbiz-purple/10">
                  Contact Support
                </Button>
              </div>
            </div>
